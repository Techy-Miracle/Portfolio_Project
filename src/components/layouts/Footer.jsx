    ...
    <div className='w-full h-full bg-[#1c546F]'>
      <div className='md:max-w-[1240px] w-full mx-auto py-16 px-4 grid lg:grid-cols-3 gap-4 text-gray-300'>
        <div>
          ...
          <p className='py-2'>
            I hope you enjoyed going through this portfolio!
          </p>
          <p>
          ...
          <div className='flex justify-between md:w-[70%] w-1/2 my-4 mt-10 cursor-pointer text-teal-600 '>
            <a href='https://github.com/Mfonn'>
              <FaGithub
                size={30}
                className='hover:text-gray-100 hover:bg-teal-500 duration-500'
              />{" "}
            </a>
            <a href='https://linkedin.com/in/mfonnta'>
              <FaLinkedin
                size={30}
                className='hover:text-gray-100 hover:bg-teal-500 duration-500'
              />{" "}
            </a>
            <a href='https://mfon.hashnode.dev/'>
              <FaHashnode
                size={30}
                className='hover:text-gray-100 hover:bg-teal-500 duration-500'
              />{" "}
        ...
        <div className='lg:col-span-2  grid grid-cols-2 md:grid-cols-3 gap-6 w-full mt-10'>
          <div>
            <ul>
              ...
              <li className='py-2 text-sm cursor-pointer hover:text-pink-600'>
                Experience
              </li>
              <li className='py-2 text-sm cursor-pointer hover:text-pink-600'>
                Projects
          ...
          <div>
            <ul>
              <li className='font-semibold text-white uppercase hover:text-gray-100 bg-pink-950'>
                Collaborations
              </li>
              <li className='py-2 text-sm cursor-pointer hover:text-pink-600'>
                Business
