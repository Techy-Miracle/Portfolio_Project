    ...
    <section className='bg-black mt-10 md:px-32 md:mx-auto mx-auto pb-10'>
      <div className='w-full py-8 max-w-[1240px] mx-auto grid md:grid-cols-2  '>
        <div className='flex flex-col justify-center '>
          <p className='text-white  md:text-4xl text-xl text-center md:text-start uppercase underline hover:text-blue-500'>
            Medicine
          </p>
        </div>
      </div>

      <div className='mt-8 grid lg:grid-cols-3  px-4 md:px-0  gap-10 mx-auto'>
